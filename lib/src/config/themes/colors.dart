...
class AppColors {
  ...
  final _accentColor = SystemTheme.accentColor.accent.toAccentColor();

  AccentColor get systemAccent => _accentColor;

  List<Map<String, Object>> get accentColors => [
        {"color": systemAccent, "name": "System"},
